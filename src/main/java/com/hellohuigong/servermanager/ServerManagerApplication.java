package com.hellohuigong.servermanager;
...
import static com.hellohuigong.servermanager.enumeration.Status.SERVER_DOWN;
import static com.hellohuigong.servermanager.enumeration.Status.SERVER_UP;
...
//	}
	...
	public CorsFilter corsFilter() {
		...
		corsConfiguration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://localhost:4200", "https://server-mamager.hellohuigong.com"));
